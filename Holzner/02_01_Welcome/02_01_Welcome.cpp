...
// 02_01_Welcome.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CWelcomeApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CWelcomeApp::OnAppAbout)
...
// Создание CWelcomeApp

CWelcomeApp::CWelcomeApp() noexcept
{
	...
	SetAppID(_T("My0201Welcome.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CWelcomeApp
...
BOOL CWelcomeApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMy0201WelcomeDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMy0201WelcomeView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CWelcomeApp
...
// Методы загрузки или сохранения настроек CWelcomeApp

void CWelcomeApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CWelcomeApp::LoadCustomState()
{
}

void CWelcomeApp::SaveCustomState()
{
}
