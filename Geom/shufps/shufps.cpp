...
int main()
{
	...
	float v0[4] = { 0.0f, 0.1f, 0.2f, 0.3f };
	float v1[4] = { 0.4f, 0.5f, 0.6f, 0.7f };
	...
	// Rotate Left: { r0[ 1 ], r0[ 2 ], r1[ 3 ], r1[ 0 ] }
	std::cout << "Rotate Left: { r0[ 1 ], r0[ 2 ], r1[ 3 ], r1[ 0 ] }" << std::endl;
	r2 = _mm_shuffle_ps(r0, r0, _MM_SHUFFLE(0, 3, 2, 1));
	...
	// Rotate Left: { r0[ 2 ], r0[ 3 ], r1[ 0 ], r1[ 1 ] }
	std::cout << "Rotate Left: { r0[ 2 ], r0[ 3 ], r1[ 0 ], r1[ 1 ] }" << std::endl;
	r2 = _mm_shuffle_ps(r2, r2, _MM_SHUFFLE(1, 0, 2, 3));
